...
throughput = pd.read_csv("output/summary/throughput_comparison.csv")
print(throughput[["scenario", "throughput_trains_per_hour",
                  "headway_avg_s", "delay_depart_avg_s"]])
